...
These slides were originally developed by Meredith Franklin (and Paul Marjoram) and modified by George G. Vega Yon, Dylan Cable, and Kelly Street.
...
met <- read.csv('../data/met/met_all.gz')
met <- met[met$temp > -10, ]
