...
All with a fertility dataset and the [MET](https://github.com/dmcable/BIOSTAT620W26/tree/main/data/met) dataset.
...
Take a look at this very neat cheat sheet
[here](https://github.com/rstudio/cheatsheets/raw/main/datatable.pdf).
...
met_url <- "https://github.com/dmcable/BIOSTAT620W26/raw/main/data/met/met_all.gz"
...
```{r echo=FALSE, eval = TRUE, cache = FALSE, echo = TRUE}
# Question 1
...
with size, e.g. integers can be of 8, 16, and 32 bits. This is relevant
...
```{r stations-data, cache = FALSE, warning=FALSE, echo=TRUE}
...
```{r merge-try1, cache = FALSE, echo=TRUE}
merge(
  # Data
  x     = dat,      
  y     = stations, 
